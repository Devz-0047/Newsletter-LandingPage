    ...
    return (
        <div className="grid md:grid-cols-2 md:grid-rows-1 min-h-screen place-items-center gap-1 ">
            ...
            <div className="flex flex-col items-start justify-center text-left md:ml-[-5rem] gap-[4rem] mt-3 md:mt-5 sm:mt-4">
                ...
                <h1 className="flex flex-col justify-start text-7xl sm:text-8xl font-bold font-secondary md:gap-4 gap-2 items-center md:items-start mt-[-1rem]">
                    <span>The</span>
                ...
                <h2 className="text-3xl md:text-4xl font-bold flex flex-col font-secondary items-center md:items-start mx-auto md:mx-0 mt-[-1rem]">
            ...
            <div className="flex items-center justify-center lg:border-[3rem] border-4 sm:border-6 border-[#FFD4D0] md:mr-[4rem] md:border-[1rem] mt-4">
                <img src="/images/image0.jpg" className="w-[28rem] h-[28rem] md:w-[38rem] md:h-[32rem] lg:w-[46rem] lg:h-[36rem] object-cover mx-auto md:mx-0"/>
            </div>
        </div>
    );
}
